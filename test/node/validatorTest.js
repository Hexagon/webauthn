...
describe("assertion validation", function () {
  ...
  beforeEach(async function () {
    ...
    testReq.response.authenticatorData = h.lib.assertionResponse.response
      .authenticatorData.slice(0);
    testReq.response.signature = h.lib.assertionResponse.response.signature
      .slice(0);
    testReq.response.userHandle = h.lib.assertionResponse.response.userHandle
      .slice(0);
