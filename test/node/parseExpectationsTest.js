...
describe("parseExpectations", function () {
  ...
  it("throws when prevCount is not a number", function () {
    ...
    assert.throws(
      ...
      TypeError,
      "expected 'prevCounter' should be Number, got string",
    );
  });
  ...
  it("throws when publicKey is not a string", function () {
    ...
    assert.throws(
      ...
      TypeError,
      "expected 'publicKey' should be String, got object",
    );
  });
  ...
  it("adds allowCredentials to map when it exists", function () {
    ...
    assert.isTrue(
      abEqual(allowCredentials[0].id, expectedallowCredentialsId),
  ...
  it("throws when allowCredentials is not a array", function () {
    ...
    assert.throws(
      ...
      TypeError,
      "expected 'allowCredentials' to be null or array, got object",
    );
  });
