    ...
    describe("parsing attestation with " + run.functionName, function () {
      ...
      describe("validateExpectations", function () {
        ...
        it("throws if optionalExpectations aren't Set", function () {
          ...
          return assert.isRejected(
            attResp.validateExpectations(),
            Error,
            "optionalExpectations should be of type Set",
          );
        });
        ...
        it("works with valid allowCredentials", async function () {
          attResp.expectations.set("allowCredentials", [{
        ...
        it("throws on missing id in allowCredentials", function () {
          ...
          return assert.isRejected(
            attResp.validateExpectations(),
            Error,
            "expected id of allowCredentials[0] to be ArrayBuffer",
          );
        });
        ...
        it("throws on missing type in allowCredentials element", function () {
          ...
          return assert.isRejected(
            attResp.validateExpectations(),
            Error,
            "expected type of allowCredentials[0] to be string with value 'public-key'",
          );
        });
        ...
        it("throws on wrong transports type in allowCredentials element", function () {
          ...
          return assert.isRejected(
            attResp.validateExpectations(),
            Error,
            "expected transports of allowCredentials[0] to be array or null",
          );
        });
        ...
        it("throws on wrong transports value in allowCredentials element", function () {
          ...
          return assert.isRejected(
            attResp.validateExpectations(),
            Error,
            "expected transports of allowCredentials[0] to be string with value 'usb', 'nfc', 'ble', 'internal' or null",
          );
        });
      ...
      describe("validateTransports", function () {
        ...
        it("throws on non-Array", function () {
          ...
          return assert.isRejected(
            attResp.validateTransports(),
            Error,
            "expected transports to be 'null' or 'array<string>'",
          );
        });
        ...
        it("throws on non-Array<string>", function () {
          ...
          return assert.isRejected(
            attResp.validateTransports(),
            Error,
            "expected transports[0] to be 'string'",
          );
        });
      });
      ...
      describe("validateAudit for 'none' attestation", function () {
        ...
        it("throws on untested verifies", function () {
          return assert.isRejected(
            ...
            Error,
            "internal audit failed: challenge was not validated",
          );
        });
...
describe("assertion validation", function () {
  ...
  beforeEach(async function () {
    ...
    testReq.response.clientDataJSON = assertionResponseCopy.response
      .clientDataJSON.slice(0);
    testReq.response.authenticatorData = assertionResponseCopy.response
      .authenticatorData.slice(0);
    testReq.response.signature = assertionResponseCopy.response.signature
      .slice(0);
    testReq.response.userHandle = assertionResponseCopy.response.userHandle
      .slice(0);
  ...
  describe("validateId", function () {
    ...
    it("throws on allowCredentials not includes rawId", function () {
      assnResp.expectations.set("allowCredentials", [{
        type: "public-key",
