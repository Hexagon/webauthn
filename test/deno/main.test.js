...
describe("Webauthn", function () {
  ...
  describe("attestationOptions", function () {
    ...
    it("accepts extraData and returns rawChallenge", async function () {
      ...
      assert.isTrue(
        abEqual(abToBuf(challenge), abToBuf(calculatedChallenge)),
      ...
      const makeCredentialAttestationSafetyNetResponse = {
        ...
        response: {
          ...
          clientDataJSON: coerceToArrayBuffer(
            "",
            "clientDataJSON",
          ),
        },
      };
    ...
    it("valid assertion without counter supported", function () {
      ...
      const assertionResponse = {
        ...
        response: {
          ...
          clientDataJSON: coerceToArrayBuffer(
            "eyJ0eXBlIjoid2ViYXV0aG4uZ2V0IiwiY2hhbGxlbmdlIjoiZ19QdTMyYnBsdWt0eHVnTk5CTFgtWk81Tjl1YjBENTBiSkVSYktpVTJHV09OM21kMHJSOUNhUVlkUEhkQ2dvLWRwaTEtOWdiSkp2bUN1SERuaDA0UmciLCJvcmlnaW4iOiJodHRwczovL21pZ2h0eS1maXJlYW50LTg0LmxvY2EubHQifQ",
            "clientDataJSON",
          ),
          signature: coerceToArrayBuffer(
            "MEQCIEhIhQBglBn1iGMDgF4WFDG7ISJHD1C1Q60drTaijjV2AiBOnQleadMnzcMJ0EBpwoP8zr2V5lBuKvpNfJrcbC1T4w",
            "signature",
          ),
        },
      };
  ...
  describe("addAttestationFormat", function () {
    ...
    it("throws on bad parseFn", function () {
      assert.throws(
        () => {
          Webauthn.addAttestationFormat("foo", [], function () {});
        },
        TypeError,
  ...
  describe("parseAttestation", function () {
    ...
    beforeEach(function () {
      ...
      Webauthn.addAttestationFormat("foo", parseStub, validateStub);
    });
    ...
    it("throws if parseFn doesn't return Map", function () {
      assert.throws(
        () => {
          Webauthn.parseAttestation("foo", { test: "yup" });
        },
        Error,
  ...
  describe("findMdsEntry", function () {
    ...
    it("throws if a global MDS collection hasn't been set", function () {
      assert.throws(
        function () {
          Webauthn.findMdsEntry("4e4e#4005");
        },
        Error,
