...
describe("Fido2AttestationResult", function () {
  ...
  /*it(
    "passes with 'u2f' attestation", async function() {
  ...
  /*it(
    "passes with Hypersecu u2f attestation", , async function() {
  ...
  /*it(
    "passes with Sam's first u2f attestation", , async function() {
		var samAnon1 = {
  ...
  /*it(
    "passes with Sam's second u2f attestation", , async function() {
		var ffNonAnon = {
  ...
  /*it(
    "passes with 'packed' attestation", async function() {
  ...
  /*it(
    "passes with 'tpm' attestation", , async function() {
