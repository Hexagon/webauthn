...
export function parseAuthenticatorData(authnrDataArrayBuffer: any): Map<any, any>;
export function parseAuthnrAssertionResponse(msg: any): Map<any, any>;
export function parseAuthnrAttestationResponse(msg: any): Map<any, any>;
