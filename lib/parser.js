import { abToStr, coerceToArrayBuffer, coerceToBase64Url, tools } from "./utils.js";
...
async function parseAuthnrAssertionResponse(msg) {
  ...
  const sigAb = coerceToArrayBuffer(
    msg.response.signature,
    "response.signature",
  );
  const ret = new Map([
    ["sig", sigAb],
    ...
    [
      "rawAuthnrData",
      coerceToArrayBuffer(
        msg.response.authenticatorData,
